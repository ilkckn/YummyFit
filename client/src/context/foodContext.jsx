...
function FoodContextProvider({ children }) {
  ...
  const dishTypeList=[
    ...
    {title:"soup",image:"https://img.freepik.com/free-photo/red-lentil-soup-with-slice-lemon-breadcrumbs_140725-1001.jpg?t=st=1745935260~exp=1745938860~hmac=5596def709881014d9ce60e1cd31647dd8ac515f9b7788fcc06d58ea95888fde&w=826"},
    ...
    const fetchFood = async () => {
      try {
        const res = await axios.get(
          `https://api.spoonacular.com/recipes/random?apiKey=c2a5e3c185e0427cb448401a8f6653a2&number=150&includeNutrition=true`
        );
